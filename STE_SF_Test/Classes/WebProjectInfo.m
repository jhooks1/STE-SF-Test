...
{
    NSString *projectFolderFullPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent: [self folderPath]];
    NSString *descriptorPath = [projectFolderFullPath stringByAppendingPathComponent: kDescriptorFileName];
    
    NSError *readError = nil;
    NSString *startPage = [NSString stringWithContentsOfFile: descriptorPath encoding: NSUTF8StringEncoding error: &readError];
