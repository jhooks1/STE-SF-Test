...
-(void)plotHandleNotification:(UILocalNotification*)notification data:(NSString*)data {
    ...
    [self.commandDelegate evalJs:
     [NSString stringWithFormat:@"cordova.require(\"com.plotprojects.plugin.PlotCordovaPlugin\")._runNotificationHandler(%@)", [n JSONString]]];
}
...
-(void)plotFilterNotifications:(PlotFilterNotifications*)_filterNotifications {
    ...
    [self.commandDelegate evalJs:
     [NSString stringWithFormat:@"cordova.require(\"com.plotprojects.plugin.PlotCordovaPlugin\")._runFilterCallback(%@)", [notifications JSONString]]
     ];
